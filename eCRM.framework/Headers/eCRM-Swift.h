...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="eCRM",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class UIImage;

SWIFT_CLASS("_TtC4eCRM11APUserModel")
...
SWIFT_CLASS("_TtC4eCRM7eCRMSDK")
@interface eCRMSDK : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) eCRMSDK * _Nonnull shared;)
+ (eCRMSDK * _Nonnull)shared SWIFT_WARN_UNUSED_RESULT;
...
- (void)createAccount:(APUserModel * _Nonnull)user :(void (^ _Nonnull)(NSInteger, NSString * _Nonnull))completion;
- (void)captureFace:(void (^ _Nonnull)(UIImage * _Nonnull))completion;
@end
...
@interface eCRMSDK (SWIFT_EXTENSION(eCRM)) <AVCaptureVideoDataOutputSampleBufferDelegate>
